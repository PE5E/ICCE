...
{
    storeValue(lhs.value, value);                                                                   // store
}

void (*storeValue)(int place, int value) = lhs.type == OperandType::Register ? &storeRegister : // memory or register?
                                           lhs.type == OperandType::Memory ? &storeMemory : 
                                                                            nullptr;
